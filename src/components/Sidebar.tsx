...
const nav: { id: string; label: string; icon: React.ReactNode; roles: Role[] }[] = [
  { id: 'home', label: 'Inicio', roles: ['admin', 'operator'], icon: <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"/><polyline points="9 22 9 12 15 12 15 22"/></svg> },
  ...
  { id: 'screens', label: 'Pantallas', roles: ['admin', 'operator'], icon: <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="2" y="3" width="20" height="14" rx="2"/><path d="M8 21h8m-4-4v4"/><path d="M1 7l3-3m19 3l-3-3"/></svg> },
