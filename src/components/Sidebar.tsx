...
const nav: { id: string; label: string; icon: React.ReactNode; roles: Role[] }[] = [
  ...
  { id: 'campaigns', label: 'Campañas', roles: ['admin', 'operator', 'seller', 'client'], icon: <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M3 11l18-5v12L3 14v-3z"/><path d="M11.6 16.8a3 3 0 1 1-5.8-1.6"/></svg> },
  { id: 'stats', label: 'Estadísticas', roles: ['admin', 'operator', 'seller', 'client'], icon: <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><line x1="18" y1="20" x2="18" y2="10"/><line x1="12" y1="20" x2="12" y2="4"/><line x1="6" y1="20" x2="6" y2="14"/></svg> },
